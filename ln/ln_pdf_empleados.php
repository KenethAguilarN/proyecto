...
class ln_pdf_empleados extends FPDF{
    var $ln_personas;
    ...
    function __construct(){
        ...
        $this->ln_personas = new ln_personas();
    }
    ...
    function export($output="I"){
        ...
        if($output=="F"){
            $path = "assets/pdf/rpt_empleados_(".date('Y-m-d').").pdf";
        }else{
            $path = "rpt_empleados_(".date('Y-m-d').").pdf";
        }
    ...
    function get_table_personas(){
        ...
        $data = $this->ln_personas->get_personas();
        /* 
    ...
    */
    ...
    function Header(){
        ...
        $this->Cell(20);
        // Título
        $this->Cell(0,10,'Reporte de Empleados','B',0,'L');
        // Salto de línea
        $this->Ln(20);
